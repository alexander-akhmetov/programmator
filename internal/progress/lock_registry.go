...
// registerActiveLock marks a log file as locked by this process.
...
// unregisterActiveLock removes a log file lock entry for this process.
...
// IsPathLockedByCurrentProcess reports whether this process holds the lock for path.
